...
networks. In the empirical research, I calculated the volatility spillover index (see e.g., [Rolling total volatility spillover index of currencies](/RTVSI.bnp)) and enabled network visualization (see e.g., [volatility connectedness network of currencies](/VCNC.bmp)). My undergraduate thesis (see the [Abstract](/Abs.pdf)) was completed on this basis. Then with the instruction of my supervisor, I 
